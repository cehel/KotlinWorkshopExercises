...
class CacheableProperty() {
    ...
    The duration specifies how long the property will be cached. f.ex you can create a durationInHour. If the time is over, it will use the generator-function to regenerate the value
